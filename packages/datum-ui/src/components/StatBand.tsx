// StatBand — Datum §19.
// Four mono figures with caption labels (years, max tonnage, max Ø, sectors
// served), each sourced from the approved entity/capability record. Putting
// measurable capability in the first viewport is the single highest-leverage
// UX decision on the site (Phase 1 §4: our users verify, they don't browse).
// Principle 5 (nothing unattributed): each figure carries its source caption.
